...
def WriteCSVFile(fileName, myList):
    ...
    f = open(fileName+datetime.datetime.now().strftime("_%Y%m%d_%H%M") +
             '.csv', 'w', encoding='UTF8')
...
getElement.send_keys("PakiRETURN)
...
i = driver.find_element_by_xpath(
    "//*[@id=\"cdk-overlay-0\"]/nz-modal-container/div/div/div/ecp-update-delivery-location/ecp-lazy-google-map-wrapper/div/div[2]/form/div/div/div[1]/nz-form-item/nz-form-control/div/div/nz-select/nz-select-top-control/nz-select-search/input")
...
interdic = {"address": "Neka Pura, Sialkot, Punjab, Pakistan", "name": "Neka Pura, Sialkot, Punjab, Pakistan",
            "placeId": "ChIJcWmQs4fqHjkRRf7DH3jsA7U", "latitude": 32.4851972, "longitude": 74.54779289999999, "city": "Sialkot", "country": "Pakistan"}
